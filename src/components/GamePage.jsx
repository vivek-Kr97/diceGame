      ...
      <div className="flex flex-col justify-center items-center gap-[24px]">
        <button
          className="w-[220px] h-[44px] rounded-[5px] text-black
            border-solid mt-6 border-[2px] border-black
            hover:border-solid hover:border-[2px] hover:border-white
            hover:text-white hover:bg-black px-[18px] py-[10px]
            duration-[.3s] ease-in"
          onClick={resetScore}
        >
          Reset Score
        ...
        <button
          className="w-[220px] h-[44px] rounded-[5px] text-white
            ...
            hover:border-solid hover:border-[2px] hover:border-black
            hover:text-black bg-black px-[18px] py-[10px]
            hover:bg-white duration-[.3s] ease-in"
